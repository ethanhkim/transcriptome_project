...
Zeng_Layer1 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 1")
Zeng_Layer2 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 2")
Zeng_Layer3 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 3")
Zeng_Layer4 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 4")
Zeng_Layer5 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 5")
Zeng_Layer6 <- filter(Zeng_filtered_dataset, marker_annotation == "layer 6") %>%
